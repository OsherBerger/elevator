...
//     if (!this.isMoving) {
//       this.isMoving = true;
//       const travelDistance = Math.abs(this.currentFloor.level - floor.level); 
//       const animationDuration = travelDistance * 0.5 * 1000; 
//       this.elevatorElement.style.setProperty('--animation-duration', `${animationDuration}ms`);
//       this.elevatorElement.style.setProperty('--target-floor', floor.level.toString());
//       this.elevatorElement.style.setProperty('--current-floor', this.currentFloor.level.toString());
